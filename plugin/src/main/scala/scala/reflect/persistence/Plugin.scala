  ...
  private object PluginComponent extends NscPluginComponent {
    ...
    def newPhase(prev: Phase) = new StdPhase(prev) {
      def apply(unit: CompilationUnit) {
        ...
        println(tempNameMap) /* TODO: remove */
      }
    }
    ...
    /* TODO: replace names in DecTree by the one generated by the var below */
    
    var tempNameMap = Map[String, List[Int]]()
    def addName(name: String, pos: Int) = if (tempNameMap.contains(name)) tempNameMap += (name -> (tempNameMap(name) :+ pos)) 
        else tempNameMap += (name -> (pos :: Nil))
    def addDefName(name: String, pos:Int) = if (tempNameMap.contains(name)) tempNameMap += (name -> (pos :: tempNameMap(name)))
    	else tempNameMap += (name -> (pos :: Nil))
    ...
    object TreeDecomposer {
      def apply(tree: Tree): DecTree = {
        ...
        var count = -1 /* Simple counter for name occurrence position */
          ...
          case x :: xs =>
            ...
            val res = x match {
              ...
              case ClassDef(mods, name, tparams, impl) =>
                nameList :+= name // TODO: remove when name list replaced
                addDefName(name.toString(), count)
              ...
              case This(qual) =>
                nameList :+= qual // TODO: remove when name list replaced
                addName(name.toString(), count)
              ...
              case SelectFromTypeTree(qualifier, selector) =>
                nameList :+= selector // TODO: remove when name list replaced
                addName(name.toString(), count)
              ...
              case Super(qual, mix) =>
                nameList :+= mix // TODO: remove when name list replaced
                addName(name.toString(), count)
